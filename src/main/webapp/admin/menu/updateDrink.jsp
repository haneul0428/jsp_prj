    ...
    <div class="row">
        ...
        <form>
            ...
            <div class="image-upload">
                <img id="image-preview" src="http://192.168.10.214/jsp_prj/admin/common/image/HOT-%EC%95%97%EB%A9%94%EB%A6%AC%EC%B9%B4%EB%85%B8-450x588.png" alt="이미지 미리보기" style="">
			...
			<fieldset>
			    ...
			    <table id="ingredientTable">
			        ...
			        <tr>
				        ...
				        <a href="http://192.168.10.214/jsp_prj/admin/menu/getListDrink.jsp">확인</a></button>
