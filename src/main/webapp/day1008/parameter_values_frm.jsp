...
<form name="frmGet" id="frmGet" method="get" action="parameter_values_frm_process.jsp">
	...
	<div>
	<input type="button" value="GET방식 값전송" class="btn btn-outline-info btn-sm" id="btnGet"/>
	</div>
</form>
...
<form name="frmPost" id="frmPost" method="post" action="parameter_values_frm_process.jsp">
	...
	<div>
	<input type="button" value="POST방식 값전송" class="btn btn-outline-success btn-sm" id="btnPost"/>
	</div>
</form>
</div>
