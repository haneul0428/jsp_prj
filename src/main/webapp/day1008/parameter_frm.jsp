...
$(function(){
	$("#btnGet").click(function() {
		//HTML Form Control의 값을 전달할려면 <form>의 submit()을 호출해야 함
		$("#frmGet").submit();
	});
...
<div id="wrap">
	<h2>GET방식 HTML Form Control 값전송</h2>
	<form name="frmGet" id="frmGet" action="parameter_frm_process.jsp" method="GET">
	<table>
	<tr>
		<td><label for="text">text</label></td>
		<td><input type="text" name="text" id="text" class="inputBox" style="width: 150px"/></td>
	</tr>
	<tr>
		<td><label for="pass">password</label></td>
		<td><input type="password" name="pass" id="pass" class="inputBox" style="width: 150px"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="hidden" name="hid" id="hid" value="숨김값"/></td>
	</tr>
	<tr>
		<td><label for="select">select</label></td>
		<td><select name="sel" id="select" class="inputBox" style="width: 150px">
	...
	<tr>
		<td><label for="ta">textarea</label></td>
		<td>
	...
	<tr>
		<td colspan="2">
			<input type="button" value="GET 값전송" class="btnMy" id="btnGet"/>
		</td>
	</tr>
	</table>
	</form>
	
	<h2>POST방식 HTML Form Control 값전송</h2>
	...
	<tr>
		<td colspan="2">
			<input type="button" value="POST 값전송" class="btnMy" id="btnPost"/>
		</td>
	</tr>
	</table>
	</form>
