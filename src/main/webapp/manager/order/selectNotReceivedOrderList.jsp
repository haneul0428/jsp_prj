...
<head>
    ...
    <link rel="stylesheet" href="http://192.168.10.214/jsp_prj/manager/common/css/orderStateList.css">
    <link rel="stylesheet" href="http://192.168.10.214/jsp_prj/manager/common/css/orderDetails.css">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://192.168.10.214/jsp_prj/manager/order/getListOrder.jsp">
