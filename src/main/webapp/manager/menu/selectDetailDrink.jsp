...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>  
    ...
    $(function(){
     	$("#confirm").click(function(){
			//var url="http://192.168.10.214/jsp_prj/manager/menu/selectDrinkList.jsp?currentPage=${ param.currentPage }"
			var url="http://192.168.10.214/jsp_prj/manager_v1.1/menu/selectDrinkList.jsp?currentPage=${ param.currentPage }"
