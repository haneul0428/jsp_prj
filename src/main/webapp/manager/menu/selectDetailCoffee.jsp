...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>  
    ...
    $(function(){
     	$("#confirm").click(function(){
			//var url="http://192.168.10.214/jsp_prj/manager/menu/selectCoffeeList.jsp?currentPage=${ param.currentPage }"
			var url="http://192.168.10.214/jsp_prj/manager_v1.1/menu/selectCoffeeList.jsp?currentPage=${ param.currentPage }"
    ...
    <div class="row">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://192.168.10.214/jsp_prj/manager/menu/getListDrink.jsp">
        ...
        <form action="selectCoffeeList.jsp" name="readFrm" id="readFrm" method="post">
            ...
            <div class="image-upload">
                <img id="preview" src="http://192.168.10.214/jsp_prj/manager/common/image/${ pVO.image }" alt="이미지 미리보기" style="">
