...
<div class="container-fluid">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="http://192.168.10.214/jsp_prj/manager/customer/list_customer.jsp">
                                <i class="bi bi-people"></i>
                                회원 관리
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="http://192.168.10.214/jsp_prj/manager/voc/getListCustomSound.jsp">
    ...
    <table class="user">
        ...
        <tbody>
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user1</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user22</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">userXrd</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user4th</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user555</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">6ser</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user777</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user8888</a></td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user999</a></td>
                <td class="name">강철</td>
            ...
            <tr>
                <td class="id"><a href="http://192.168.10.214/jsp_prj/manager/customer/modify_customer.jsp">user0000</a></td>
