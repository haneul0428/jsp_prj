<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="이동한 페이지 - 이전 페이지에서 사용한 값을 사용할 수 X"
    %>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrap">
	<%-- <%= name %> 이전 페이지에서 존재하는 변수를 사용할 수 있는 방법이 X
	scriptlet : 지역변수 --> 사용불가
	declaration : 인스턴스변수 --> 개발자가 이전 페이지의 객체를 사용할 수 없으므로, 사용불가
				: static변수 --> 개발자가 이전 페이지의 클래스명을 사용할 수 없으므로, 사용불가
	--%>
	작업 페이지 입니다.
</div>
