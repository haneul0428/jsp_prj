...
<style type="text/css">
	...
	.inputBox{
		border: 1px solid #DEDEDE; height: 37px; width: 350px;
	}
	.check{
		color: #FF0000;
	}
...
<div class="sub_section cmnt_wrap">
    <div class="container">
        <span style="display: block; text-align: left;">회원가입</span>
        <table>
        <tbody>
        <tr>
        	<td rowspan="2"><span class="check">• </span>아이디</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>(영문소문자/숫자, 4~16자)</span></td></tr>
        <tr>
        	<td rowspan="2"><span class="check">• </span>비밀번호</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)</span></td></tr>
        <tr>
        	<td rowspan="2"><span class="check">• </span>비밀번호 확인</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>비밀번호가 일치하지 않습니다.</span></td></tr>
        <tr>
        	<td rowspan="2"><span class="check">• </span>이름</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>이름을 입력해주세요.</span></td></tr>
        <tr>
        	<td rowspan="2"><span class="check">• </span>휴대폰 번호</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>휴대폰 번호를 입력해주세요.</span></td></tr>
        <tr>
        	<td rowspan="2"><span class="check">• </span>이메일</td>
        	<td><input type="text" class="inputBox"/></td>
        </tr>
        <tr><td><span>이메일을 입력해주세요.</span></td></tr>
        </tbody>
        </table>
    </div>
</div>
