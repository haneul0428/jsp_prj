	...
	<table>
		...
		<tr>
			...
			<td style="width: 400px;">
				<input type="text" id="subject" name="subject" style="width: 390px;" autofocus="autofocus"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="text-align: center;">
				<input type="button" id="btnWrite" value="글쓰기" class="btn btn-sm btn-outline-success"/>
